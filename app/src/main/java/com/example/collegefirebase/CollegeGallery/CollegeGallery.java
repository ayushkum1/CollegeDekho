package com.example.collegefirebase.CollegeGallery;
...
import com.example.collegefirebase.CollegeGallery.Photos.AllCollegeImages;
import com.example.collegefirebase.CollegeGallery.YouTubeAPI.CompleteVideoList;
import com.example.collegefirebase.CollegeGallery.YouTubeAPI.Fragments.YoutubeVideoList;
import com.example.collegefirebase.Model.College;
import com.example.collegefirebase.CollegeGallery.Photos.Utils.Grid.CollegeImageGrid;
...
public class CollegeGallery extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ref.child(String.valueOf(collegeid)).addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
               //object of College class to get getImageurls() which has the list of urls
                ...
                imagegrid = new CollegeImageGrid(CollegeGallery.this,clg.getInfra_imageurls());
        ...
        morevideos.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                // passing the college id,  which will be used to extract playlist id from videourls in the next activity.
