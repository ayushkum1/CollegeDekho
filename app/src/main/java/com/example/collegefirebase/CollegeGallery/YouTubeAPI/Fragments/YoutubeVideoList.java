package com.example.collegefirebase.CollegeGallery.YouTubeAPI.Fragments;
...
import com.example.collegefirebase.CollegeGallery.YouTubeAPI.Utils.YoutubeAdapter;
                        ...
                        public void onResponse(String response) {
                            ...
                            try {
                                ...
                                for (int i = 0; i < itemArray.length(); i++) {
                                    ...
                                    String desc = itemArray.getJSONObject(i).getJSONObject("snippet").getString("description");

                                    YoutubeVideoModel vid = new YoutubeVideoModel(title, url, vidid, desc);
