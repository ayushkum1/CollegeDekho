...
public class LabsPhotos extends BaseAdapter {
    private Context c;
    private List<String> collegelist;

    public LabsPhotos(Context c, List<String> collegelist) {
        this.c = c;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(convertView == null){
            grid = new View(c);
            grid = inflater.inflate(R.layout.activity_labs_photos,null);
